...
import SwitchButtons from '../MapComponents/SwitchBotton';

describe('SwitchButtons Component', () => {
  it('renders correctly with both buttons', () => {
    const { getByText } = render(
      <SwitchButtons onSwitchToSGW={() => {}} onSwitchToLoyola={() => {}} />
    );
  ...
  it('calls onSwitchToSGW when "Switch to SGW" is pressed', () => {
    ...
    const { getByText } = render(
      <SwitchButtons onSwitchToSGW={mockOnSwitchToSGW} onSwitchToLoyola={() => {}} />
    );
  ...
  it('calls onSwitchToLoyola when "Switch to Loyola" is pressed', () => {
    ...
    const { getByText } = render(
      <SwitchButtons onSwitchToSGW={() => {}} onSwitchToLoyola={mockOnSwitchToLoyola} />
    );
